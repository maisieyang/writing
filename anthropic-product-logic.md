...
Layer 1 是 "agent 本身"，Layer 2 是 "agent 怎么到达用户"，Layer 3 + 4 是 "agent 怎么变成行业专家"。三件事在 Anthropic 的产品矩阵里清晰分层、相互正交。因此，Anthropic 的行业扩张不是“每个行业重做一个产品”，而是：统一 Harness + 不同行业能力包 + 不同产品接触面。
